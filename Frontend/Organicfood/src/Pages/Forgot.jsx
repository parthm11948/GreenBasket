...
const ForgotPassword = () => {
  ...
  const handleSendOTP = async (e) => {
    ...
    setError("");
    try {
      const res = await fetch("https://green-basket-ud3o.vercel.app/api/auth/forgot-password", {
        method: "POST",
  ...
  const handleVerifyOTP = async (e) => {
    ...
    setError("");
    try {
      const res = await fetch("https://green-basket-ud3o.vercel.app/api/auth/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleReset = async (e) => {
    ...
    setError("");
    try {
      const res = await fetch("https://green-basket-ud3o.vercel.app/api/auth/reset-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
